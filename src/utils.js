...
module.exports = {
    ...
    ROOMID_MAX_LENGTH: ROOMID_MAX_LENGTH,
    PICK_MAX_LENGTH: PICK_MAX_LENGTH,
    BOARD_MAX_LENGTH: BOARD_MAX_LENGTH,
    GAMELOG_MAX_LENGTH: GAMELOG_MAX_LENGTH,
    ROOMHASHTABLE_MAX_ENTRIES: ROOMHASHTABLE_MAX_ENTRIES,
    SERVER_TIMEOUT: SERVER_TIMEOUT,
    JOINDATA_TYPES: JOINDATA_TYPES,
    PICKDATA_TYPES: PICKDATA_TYPES,
    TURNDATA_TYPES: TURNDATA_TYPES,
